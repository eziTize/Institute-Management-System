        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        <form class="col s12" action="{{ Asset(env('telecaller').'/settings') }}" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input id="phone" type="number" onkeypress="if(this.value.length==10) return false;" placeholder="Phone number must be of 10 digits" name="phone" value="{{ $data->phone }}">
