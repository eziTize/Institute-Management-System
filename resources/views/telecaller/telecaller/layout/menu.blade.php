...
<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
        ...
        <li class="<?php if($page == "job"){ echo "active"; } ?>"><a href="{{ Asset(env('telecaller').'/job') }}" class="waves-effect waves-cyan"><i class="mdi-action-work" style="font-size:16px"></i> Job</a></li>

        <li>
            <ul class="collapsible collapsible-accordion">
                <li>
                    <a class="collapsible-header waves-effect waves-cyan <?php if($page == 'enquiry_leads_open' || $page == 'enquiry_leads_called' || $page == 'enquiry_leads_walked_in' || $page == 'enquiry_leads_admitted'){ ?> active <?php } ?>"><i class="mdi-action-info-outline"></i> Enquiry Leads</a>
                    <div class="collapsible-body">
                        <ul>
                            <li class="<?php if($page == "enquiry_leads_open"){ echo "active"; } ?>"><a href="{{ Asset(env('telecaller').'/enquiry_leads_open') }}"><i class="mdi-communication-message" style="font-size:16px"></i> Open</a></li>
