	...
	<div class="card-panel">
		...
		<div class="row">
			...
			<div class="input-field col s12 l6">
				...
				<label for="sm_name">Seminar Name *</label>
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				<label for="t_plan">Detailed Plan of the Seminar *</label>
		...
		<div class="row">
			...
			<div class="input-field col s12 l6">
				...
				<label for="budget">Material Seminar Budget (Rs) *</label>
			...
			<div class="input-field col s12 l6">
				...
				<label for="expense"> Total Expense (Rs) *</label>
