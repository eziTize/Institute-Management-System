...
<div class="col s12 m12 l12">
	...
	<div class="card-panel">
		...
		<div class="row">
			...
			@include('tpo.industry-visit.upload_field')
...
<script>
	...
	function addUploadField(){
		...
		$("<div>").load("{{ Asset(env('tpo').'/industry-visit/addUploadField') }}", function(){
	...
	function Prev_Remove(id){
		...
		swal({
			...
			window.location.href = "{{ Asset(env('tpo').'/industry-visit/deleteUploadField') }}/"+id;
