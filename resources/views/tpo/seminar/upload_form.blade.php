...
<div class="col s12 m12 l12">
	...
	<div class="card-panel">
		...
		<div class="row">
			...
			@include('tpo.seminar.upload_field')
...
<script>
	...
	function addUploadField(){
		...
		$("<div>").load("{{ Asset(env('tpo').'/seminars/addUploadField') }}", function(){
	...
	function Prev_Remove(id){
		...
		swal({
			...
			window.location.href = "{{ Asset(env('tpo').'/seminars/deleteUploadField') }}/"+id;
