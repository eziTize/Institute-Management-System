	...
	<div class="card-panel">
		...
		<div class="row">
			...
			<div class="input-field col s12 l6">
				...
				<label for="sm_name">Company Name *</label>
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				<label for="t_plan">Internship Role *</label>
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				<label for="budget">Internship Budget (Rs) *</label>
		...
		<div class="row">
			...
			<div class="input-field col s12 l6">
				...
				{!! Form::text('closure',null,['id' => 'closure', 'required' => 'required']) !!}

				<label for="closure"> No. of openings *</label>
