...
@section('title') Applications Selected For Interview @endsection
...
<div class="container">
    ...
    <div class="section">
        ...
        <a href="{{ Asset($link.$opening->id.'/applications/interviewed') }}" class="btn cyan waves-effect waves-light right" style="margin-top:25px; ">Interviewed </a>
                    ...
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <form action="{{ Asset($link.$op_student->id.'/mark-interviewed') }}" method="POST" id="mark_form_{{ $op_student->id }}" class="form-inline">

                                        @csrf
                                        @method('PATCH')

                                        <button type="button" class="btn green tooltipped " data-position="top" data-delay="50" data-tooltip="Mark Interviewed" style="padding:0px 10px" onclick="confirmAlert('mark',this)"><i class="fa fa-check"></i></button>
