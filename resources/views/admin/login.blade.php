        ...
        <form class="login-form" action="{{ Asset(env('admin').'/login') }}" method="post" autocomplete="off">
          ...
          <div class="row">
            <div class="input-field col s12 m12 l12">
              <p class="margin medium-small"><a href="{{ Asset(env('branch').'/login') }}">Login in Branch Panel</a></p>
            </div>
            <div class="input-field col s12 m12 l12">
              <p class="margin medium-small"><a href="{{ Asset(env('telecaller').'/login') }}">Login in Telecaller Panel</a></p>
            </div>
            <div class="input-field col s12 m12 l12">
              <p class="margin medium-small"><a href="{{ Asset(env('tpo').'/login') }}">Login in TPO Panel</a></p>
            </div>
            <div class="input-field col s12 m12 l12">
              <p class="margin medium-small"><a href="{{ Asset(env('marketing_person').'/login') }}">Login in Marketing Person Panel</a></p>
            </div>
            <div class="input-field col s12 m12 l12">
