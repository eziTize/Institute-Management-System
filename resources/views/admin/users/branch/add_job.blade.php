...
@section('title') Job for {{ $branch->name }} @endsection
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        {!! Form::model($data, ['url' => [env('admin').'/branch/'.$branch->id.'/add_job'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
                        <h4 class="header2">Manage Job for {{ $branch->name }} Here</h4>
