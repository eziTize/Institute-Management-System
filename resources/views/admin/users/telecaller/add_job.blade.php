...
@section('title') Job for {{ $telecaller->name }} @endsection
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        {!! Form::model($data, ['url' => [env('admin').'/telecaller/'.$telecaller->id.'/add_job'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
                        <h4 class="header2">Manage Job for {{ $telecaller->name }} Here</h4>
