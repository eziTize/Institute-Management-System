...
@section('title') Telecaller / Counsellor Trash @endsection
                    ...
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="40%">{{ $telecaller->name }}</td>
                                <td width="35%">{{ $telecaller->email }}</td>
                                <td width="25%">
                                    <form action="{{ Asset($link.'restore/'.$telecaller->id) }}" method="POST" id="restore_form_{{ $telecaller->id }}" class="form-inline">
                                        @csrf
                                    ...
                                    <form action="{{ Asset($link.'destroy_permanent/'.$telecaller->id) }}" method="POST" id="delete_form_{{ $telecaller->id }}" class="form-inline">
                                        @csrf
                                        @method('DELETE')
