...
@section('title') Task for {{ $marketing_person->name }} @endsection
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                <div class="card-panel">
                    <div class="row">
                        {!! Form::model($data, ['url' => [env('admin').'/marketing_person/'.$marketing_person->id.'/add_task'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
                        <h4 class="header2">Manage Task for {{ $marketing_person->name }} Here</h4>
