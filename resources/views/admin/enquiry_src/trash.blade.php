...
@section('title') Enquiry Source Trash @endsection
                ...
                <div class="col s12 m12 l12">
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td width="75%">{{ $enquiry_src->name }}</td>
                                <td width="25%">
                                    <form action="{{ Asset($link.'restore/'.$enquiry_src->id) }}" method="POST" id="restore_form_{{ $enquiry_src->id }}" class="form-inline">
                                        @csrf
                                    ...
                                    <form action="{{ Asset($link.'destroy_permanent/'.$enquiry_src->id) }}" method="POST" id="delete_form_{{ $enquiry_src->id }}" class="form-inline">
                                        @csrf
                                        @method('DELETE')
