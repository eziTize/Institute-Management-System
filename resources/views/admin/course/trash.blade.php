                    ...
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="35%">{{ $course->duration }}</td>

                                <td width="25%">

                                    <form action="{{ Asset($link.'restore/'.$course->id) }}" method="POST" id="restore_form_{{ $course->id }}" class="form-inline">
                                    ...
                                    <form action="{{ Asset($link.'destroy_permanent/'.$course->id) }}" method="POST" id="delete_form_{{ $course->id }}" class="form-inline">
