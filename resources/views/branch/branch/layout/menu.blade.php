...
<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
        ...
        <li class="<?php if($page == "job"){ echo "active"; } ?>"><a href="{{ Asset(env('branch').'/job') }}" class="waves-effect waves-cyan"><i class="mdi-action-work" style="font-size:16px"></i> Job</a></li>
