...
@section('title') Change Course & Batch of {{ $data->name }} @endsection
    ...
    <div class="section">
        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <h4 class="header2">All Course Detail</h4>
                ...
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 l3">
                                {!! Form::date('course_join',null,['id' => 'course_join','required' => 'required','placeholder' => 'Date Added','class' => 'datepicker']) !!}
                                <label for="course_join" class="active">Course Complete</label>
                            </div>
                        </div>
                        @endforeach
                    </div>
