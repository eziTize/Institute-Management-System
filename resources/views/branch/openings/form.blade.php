	...
	<div class="card-panel">
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				{!! Form::text('company_details',null,['id' => 'company_details','required' => 'required']) !!}
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				{!! Form::text('o_details', null,['id' => 'o_details','required' => 'required']) !!}
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				{!! Form::text('eligibility', null,['id' => 'eligibility','required' => 'required']) !!}
