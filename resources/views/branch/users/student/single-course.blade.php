...
@section('title'){{ $student->find($data->student_id)->name }}'s Course Details @endsection
...
<div class="container">
    ...
    <div class="section">
        ...
        <a href="{{ Asset($link).'/'.$student_id.'/course-details' }}" class="btn cyan waves-effect waves-light right" style="margin-top:25px">Back</a>
                    ...
                    <table class="striped" >
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                @if($data->c_status == 'Complete')

                                <th style="color: green ;"> {{$data->c_status}} </th>

                                @elseif($data->c_status == 'Incomplete')

                                <th style="color: red ;"> {{$data->c_status}} </th>

                                @else

                                <th style="color: teal ;"> {{$data->c_status}} </th>
