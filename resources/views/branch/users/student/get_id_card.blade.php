...
<div class="container">
    <div class="section">
        ...
        <a href="{{ Asset($link.'generateIDCard/'.$data->id) }}" class="btn cyan waves-effect waves-light right" style="margin-top:25px;margin-right:5px;">Generate ID Card</a>
        <a href="{{ Asset($link.'printIDCard/'.$data->id) }}" target="_blank" class="btn cyan waves-effect waves-light right" style="margin-top:25px;margin-right:5px;"><i class="mdi-action-print"></i> Print ID Card</a>
        @endsection
