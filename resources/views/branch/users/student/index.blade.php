                    ...
                    <table class="striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="15%">{{ $student->login_id }}</td>

                                <td width="30%">{{ $student->name }}</td>

                                <td width="25%">{!! IMS::status($student->status) !!}</td>
                                ...
                                <td width="30%">
                                    ...
                                    <a href="{{ Asset($link.'getIDCard/'.$student->id) }}" class="btn blue tooltipped " data-position="top" data-delay="50" data-tooltip="Get ID Card" style="padding:0px 10px"><i class="mdi-action-credit-card"></i></a>
