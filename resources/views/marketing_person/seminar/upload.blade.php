            ...
            <div class="col s12 m12 l12">
                ...
                <div class="card-panel">
                    ...
                    <div class="row">
                        ...
                        {!! Form::model($data, ['method' => 'PUT','url' => env('marketing_person').'/seminars/'.$data->id.'/store-image','files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}

                        <h4 class="header2">Upload Seminar Images</h4>

                        @include('marketing_person.seminar.upload_form')
