    ...
    <div class="section">
        ...
        <div class="row">
            ...
            <div class="col s12 m12 l12">
                ...
                {!! Form::model($data, ['method' => 'PUT','url' => env('marketing_person').'/workshop/'.$data->id.'/update','files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}

                <h4 class="header2">Edit Workshop Details</h4>

                @include('marketing_person.workshop.form',['id' => $id])
