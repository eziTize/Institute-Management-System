...
<div class="col s12 m12 l12">
	...
	<div class="card-panel">
		...
		<div class="row">
			...
			@include('marketing_person.tour.upload_field')
...
<script>
	...
	function addUploadField(){
		...
		$("<div>").load("{{ Asset(env('marketing_person').'/tour/addUploadField') }}", function(){
	...
	function Prev_Remove(id){
		...
		swal({
			...
			window.location.href = "{{ Asset(env('marketing_person').'/tour/deleteUploadField') }}/"+id;
