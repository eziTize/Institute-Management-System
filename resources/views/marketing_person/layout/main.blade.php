...
<html lang="en">
  ...
  <body>
    ...
    {!! View('marketing_person.layout.header') !!}

    <div id="main">
      <div class="wrapper">

        {!! View('marketing_person.layout.menu') !!}
              ...
              <div class="row">
                <div class="col s12 m6 l6">
                  ...
                  <ol class="breadcrumbs">
                    <li><a href="{{ Asset(env('marketing_person').'/dashboard') }}">Dashboard</a></li>
        ...
        {!! View('marketing_person.layout.right') !!}
